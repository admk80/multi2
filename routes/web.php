...
Route::group(['prefix' => '/account', 'middleware' => ['auth'], 'namespace' => 'Account\Controllers', 'as' => 'account.'], function () {
    ...
    Route::get('/stores-verify', 'StoresController@storeVerify')->name('storesVerify');    
    /**
     * Notifications
     */
...
Route::get('product/categories', 'AllCategoryController@index')->name('all-categories');
Route::get('product/add-category', 'AllCategoryController@create')->name('add-category');
Route::post('product/add-category', 'AllCategoryController@store');
Route::get('product/rem-category/{id}', 'AllCategoryController@destroy')->name('remove-cat');
Route::get('product/category/edit/{id}', 'AllCategoryController@edit');
Route::post('product/category/{id}', 'AllCategoryController@update');
Route::get('product/category/','AllCategoryController@show');
Route::get('product/category/{id}','AllCategoryController@show');
## Code By Abbas, cloning Categories for brands ##
Route::get('product/brands', 'BrandsController@index')->name('all-brands');
Route::get('product/add-brand', 'BrandsController@create')->name('add-brand');
Route::post('product/add-brand', 'BrandsController@store');
Route::get('product/rem-brand/{id}', 'BrandsController@destroy')->name('remove-brand');
Route::get('product/brand/edit/{id}', 'BrandsController@edit');
Route::post('product/brand/{id}', 'BrandsController@update');
Route::get('product/brand/','BrandsController@show');
Route::get('product/brand/{id}','BrandsController@show');


Route::get('admin/products/add', 'ProductsController@create')->name('add-product');
Route::post('admin/products/add','ProductsController@store');
Route::get('admin/products/all', 'ProductsController@index')->name('products');
Route::get('admin/product/remove/{id}', 'ProductsController@destroy')->name('remove-prod');

Route::post('admin/product/edit1/{id}', 'ProductsController@update');
Route::post('admin/product/edit1/', 'ProductsController@update');
Route::get('admin/product/edit/{id}','ProductsController@show');



Route::get('product/{slug}','ProductsController@showProduct')->name('product');
Route::get('stores','StoreController@index')->name('stores');
Route::post('store','StoreController@store')->name('create.store');
// profile
Route::get('store-profile','StoreController@storeProfile')->name('store.profile');
Route::post('store-update','StoreController@storeUpdate')->name('store.update');
// profile
Route::post('store/login','StoreController@storeLogin')->name('login.check');
Route::get('store/loggout','StoreController@storeLoggout')->name('store.loggout');
Route::post('add/price','ProductsController@addPrice')->name('add.price');
Route::post('store/productPrice','ProductsController@productPrice')->name('store.productPrice');
Route::post('add_to_cart','ProductsController@addToCart')->name('addToCart');
Route::post('remove_from_cart','ProductsController@removeFromCart')->name('removeFromCart');
Route::get('my_cart','ProductsController@myCart')->name('my_cart');
Route::post('update_cart','ProductsController@updateCart')->name('updateCart');